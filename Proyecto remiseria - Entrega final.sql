...
CALL ObtenerReservasPorConductor('Diego', 'Medina');

CALL ObtenerReservasPorConductor('Fernando', 'Morales');
...
CALL AgregarCliente(
    'Gladys',             -- p_Nombre
    'Ruiz Diaz',            -- p_Apellido
    '3704329447',       -- p_Telefono
    '<gladys.ruizdiaz@gmail.com',  -- p_Email
    '20-20990091-9' -- p_Cuil
);

SELECT * FROM Clientes
WHERE Cuil = '20-20990091-9';
...
SELECT total_viajes_conductor('Claudia', 'Jimenez');
...
DROP ROLE IF EXISTS 'Gestion', 'Admin', 'Conductor';
CREATE ROLE 'Gestion', 'Admin', 'Conductor';

-- Otorgar permisos

-- ROL SISTEMA
-- Todos los permisos
GRANT ALL PRIVILEGES ON proyecto_remiseria TO 'Gestion';

-- Rol del Admin
-- DML sobre 4 tablas
GRANT SELECT, INSERT, UPDATE, DELETE ON proyecto_remiseria.conductores TO 'Admin';
GRANT SELECT, INSERT, UPDATE, DELETE ON proyecto_remiseria.autos TO 'Admin';
GRANT SELECT, INSERT, UPDATE, DELETE ON proyecto_remiseria.pagos TO 'Admin';
GRANT SELECT, INSERT, UPDATE, DELETE ON proyecto_remiseria.clientes TO 'Admin';

-- Ejecución en 2 funciones y 2 procedimientos
GRANT EXECUTE ON FUNCTION proyecto_remiseria.total_comentarios_conductor TO 'Admin';
GRANT EXECUTE ON FUNCTION proyecto_remiseria.total_viajes_conductor TO 'Admin';
GRANT EXECUTE ON PROCEDURE proyecto_remiseria.AgregarCliente TO 'Admin';
GRANT EXECUTE ON PROCEDURE proyecto_remiseria.ObtenerReservasPorConductor TO 'Admin';

-- Utilización de 4 vistas
GRANT SELECT ON proyecto_remiseria.vista_clientes TO 'Admin';
GRANT SELECT ON proyecto_remiseria.vista_conductores TO 'Admin';
GRANT SELECT ON proyecto_remiseria.vista_autos TO 'Admin';
GRANT SELECT ON proyecto_remiseria.vista_rutas TO 'Admin';
	
-- Rol del Conductor
GRANT SELECT, INSERT, UPDATE ON clientes TO 'Conductor';
GRANT SELECT, INSERT, UPDATE ON reservas TO 'Conductor';
GRANT SELECT, INSERT, UPDATE ON autos TO 'Conductor';
GRANT SELECT, INSERT, UPDATE ON viajes TO 'Conductor';
GRANT SELECT, INSERT, UPDATE ON ofertas TO 'Conductor';
GRANT SELECT, INSERT, UPDATE ON comentarios TO 'Conductor';

-- Ejecución de 1 función y 1 procedimiento
GRANT EXECUTE ON FUNCTION total_viajes_conductor TO 'Conductor';
GRANT EXECUTE ON PROCEDURE AgregarCliente TO 'Conductor';

-- Utilización de 3 vistas
GRANT SELECT ON vista_clientes TO 'Conductor';
GRANT SELECT ON vista_reservas TO 'Conductor';
GRANT SELECT ON vista_comentarios TO 'Conductor';